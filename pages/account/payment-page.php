        ...
        <div class="card-body px-0">
            ...
            <div class="d-flex align-items-center justify-content-between px-4">
                <div class="d-flex align-items-center">
                     ...
                     <img src="components/images/marcantile-bank.png" class="bank-icon" alt="Markentile Bank">
                    <div class="ms-4">
            ...
            <div class="d-flex align-items-center justify-content-between px-4">
                <div class="d-flex align-items-center">
                    ...
                    <img src="components/images/nrb-bank.png" class="bank-icon" alt="NRB Bank">
                    <div class="ms-4">
            ...
            <div class="d-flex align-items-center justify-content-between px-4">
                <div class="d-flex align-items-center">
                    ...
                    <img src="components/images/bkash.png" class="bank-icon" alt="Bkash Pay Bill">
                    <div class="ms-4">
